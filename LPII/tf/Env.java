 ...
 * Disponibiliza os métodos necessários para criar um novo ambiente, associar um
 * identificador a um valor num ambiente, terminar um ambiente, etc...
 */
...
public class Env implements IEnv {
	 ...
	 */
	private HashMap<String, IVal> env;
	...
	/**
	 * Construtor da classe, cria uma nova estrutura para guardar os
	 * identificadores e define o anterior como inexistente (null).
	 */
	public Env() {
		this.prevEnv = null;
		env = new HashMap<String, IVal>();
	}
	...
	private Env(IEnv prevEnv) {
		...
		this.env = new HashMap<String, IVal>();
	}

	/**
	 * Método que associa um identificador a um valor.
	 */
	public void assoc(String id, IVal value)
			throws IdentifierAlreadyDefinedException {
		// TODO Auto-generated method stub
		if (env.containsKey(id))
			throw new IdentifierAlreadyDefinedException(
					"Variable allready defined in this Enviroment...");
		env.put(id, value);
	}
	 ...
	 */
	public IVal find(String id) throws IdentifierNotFoundException {
		// TODO Auto-generated method stub
		if (env.containsKey(id))
			return env.get(id);
			...
			throw new IdentifierNotFoundException(
					"Identifier not defined in the Enviroment.");

	}

	/**
	 * Método que actualiza o valor do identificador id. Gera uma excepção se o
	 * identificador não estiver definido.
	 */
	public void update(String id, IVal value)
	...
	public int getNDecls() {
		if (prevEnv != null)
			return env.size() + prevEnv.getNDecls();
		return env.size();
	}
}
