...
public class Env implements IEnv {
	 ...
	 * */
	public void assoc(String id, IVal value) throws IdentifierAlreadyDefinedException{
	 ...
	 * estiver definido.
	 * */
	public void update(String id, IVal value) throws IdentifierNotFoundException{
		// TODO Auto-generated method stub
		if(env.containsKey(id))
			env.put(id, value) ;
		else
